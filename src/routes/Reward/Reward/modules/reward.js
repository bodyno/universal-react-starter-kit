...
const PAGE_CHANGE = 'PAGE_CHANGE_REWARD'
const DATA_CHANGE = 'DATA_CHANGE_REWARD'
const DATE_CHANGE = 'DATE_CHANGE_REWARD'
const SORT_CHANGE = 'SORT_CHANGE_REWARD'
...
export function changePage (page, per_page) {
  return (dispatch, getState) => {
    if (!per_page) per_page = getState().reward.per_page
