...
// Constants
// ------------------------------------
const REQUEST_DATA = 'REQUEST_DATA_ALLBOOKS'
const RECEIVE_DATA = 'RECEIVE_DATA_ALLBOOKS'
const CHECK_CHANGE = 'CHECK_CHANGE_ALLBOOKS'
const RECEIVE_PAGE = 'RECEIVE_PAGE_ALLBOOKS'
